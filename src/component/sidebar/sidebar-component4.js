...
const SidebarComponent4 =()=>{
return(
    <div className="cards fourth-card">
        <div className="card-content">
            <div className="laptop-left mr-4">
...
<span className="card-title size d-block text-center">Desktop App</span>
</span>
            </div>
        <div className="laptop-right">
            <button className="btn laptop-button mb-0  mt-3"><i className="fab fa-apple"></i> Download for MacOS</button>
            <button className="btn laptop-button mt-3 "><i className="fab fa-windows"></i>Download for Windows</button>
            </div>
            </div>
    </div>
)
...
export default SidebarComponent4;